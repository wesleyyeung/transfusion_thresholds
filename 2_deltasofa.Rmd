---
title: "Blood Transfusion - Delta SOFA"
...
```{r}
combined.data = combined.data[complete.cases(combined.data$delta_sofa),]
```
...
groups = c('6 to 6.99','7 to 7.99','8 to 8.99','9 to 9.99','10 or more')
plot(seq.int(length(groups)), df$OR, ylim= c(0,6), pch=19, col=col,
         xlab="Minimum Hemoglobin (g/dL)", ylab="Odds Ratio", xaxt = "n", main="Effect of Red Cell Transfusion On Deterioration In SOFA",
